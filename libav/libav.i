...
# 28 "./libavutil/version.h"
#define AVUTIL_VERSION_H 
# 56 "./libavutil/version.h"
...
{
    if ((a+0x80000000ULL) & ~0xFFFFFFFFULL) return (int32_t)((a>>63) ^ 0x7FFFFFFF);
...
static __attribute__((always_inline)) inline __attribute__((const)) unsigned av_zero_extend_c(unsigned a, unsigned p)
{
...
# 388 "./libavutil/common.h" 3 4
                                                                 9223372036854775807LL 
# 388 "./libavutil/common.h"
                                                                           : 
# 388 "./libavutil/common.h" 3 4
                                                                             (-9223372036854775807LL - 1)
# 388 "./libavutil/common.h"
...
#define AV_CHANNEL_LAYOUT_AMBISONIC_FIRST_ORDER { AV_CHANNEL_ORDER_AMBISONIC, 4, { 0 }, NULL }
...
# 21 "libavcodec/defs.h"
#define AVCODEC_DEFS_H 
# 40 "libavcodec/defs.h"
...
# 69 "libavcodec/packet.h"
    AV_PKT_DATA_PARAM_CHANGE,
# 90 "libavcodec/packet.h"
...
# 153 "libavcodec/packet.h"
    AV_PKT_DATA_SKIP_SAMPLES,
# 163 "libavcodec/packet.h"
...
# 123 "libavcodec/codec_par.h"
    ...
    int width;
    int height;
# 144 "libavcodec/codec_par.h"
    AVRational sample_aspect_ratio;
# 156 "libavcodec/codec_par.h"
...
# 1 "libavdevice/version_major.h" 1
# 20 "libavdevice/version_major.h"
...
# 28 "libavdevice/avdevice.h" 2
# 55 "libavdevice/avdevice.h"
# 1 "./libavutil/opt.h" 1
# 23 "./libavutil/opt.h"
#define AVUTIL_OPT_H 
# 251 "./libavutil/opt.h"
...
# 174 "libavdevice/avdevice.h"
    AV_APP_TO_DEV_SET_VOLUME = (('L') | (('O') << 8) | (('V') << 16) | ((unsigned)('S') << 24)),
# 185 "libavdevice/avdevice.h"
...
# 20 "libswscale/version.h"
#define SWSCALE_VERSION_H 
# 31 "libswscale/version.h"
